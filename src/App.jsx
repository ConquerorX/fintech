...
const fintechData = [
  ...
  { id: 21, name: "Moneytolia", status: "neutral", category: "Diğer", description: "Papara alternatifi sunuldu ama cashback yetersiz.", videoNote: "Adam akıllı cashback yok." },
  { id: 22, name: "Beeso", status: "neutral", category: "Transfer", description: "Sadece para transferi, cüzdan özelliği kısıtlı.", videoNote: "Cüzdan olarak kullanılamıyor." },
  ...
  { id: 26, name: "Dinamik Pay", status: "neutral", category: "Transfer", description: "Cüzdan hizmeti zayıf, transfer odaklı.", videoNote: "Transferle öne çıkan uygulama." },
  ...
  { id: 29, name: "Parazula (Eski ERPA Pay)", status: "caution", category: "Diğer", description: "Eski ismi ERPA Pay, şu an Parazula/Payinoll altında.", videoNote: "Önceden yasaklanmış bir kuruluş." },
  ...
  { id: 32, name: "FZY Pay - İyisee", status: "banned", category: "Yasaklı/Riskli", description: "Mal varlığı donduruldu.", videoNote: "Direkt yasaklı, kullanamazsınız." },
  ...
  { id: 34, name: "Para O", status: "neutral", category: "Diğer", description: "Yakında gelecek deniyor.", videoNote: "Kartları yakında gelecek." },
  ...
  { id: 36, name: "ist-pay", status: "inactive", category: "Diğer", description: "Görünürde var ama yok.", videoNote: "Kullanıcısı var mı bilinmiyor." },
  ...
  { id: 38, name: "Juno Money", status: "neutral", category: "Diğer", description: "Sadece web sitesi var.", videoNote: "Ne olduğu çözülemedi." },
  ...
  { id: 44, name: "NomuPay", status: "neutral", category: "Diğer", description: "Havale ve fatura ödeme yok.", videoNote: "Kimse duymadı." },
  ...
  { id: 50, name: "Payco", status: "banned", category: "Yasaklı/Riskli", description: "İzinleri kapatıldı.", videoNote: "Ç ve E hizmetleri de yoktu." },
  { id: 51, name: "Kuik Para", status: "recommended", category: "Transfer", description: "KoronaPay ile Rusya/Ukrayna transferi ücretsiz.", videoNote: "Yurt dışı transferi için en mantıklısı." },
  ...
  { id: 60, name: "TurkOnay (Elmacık Su)", status: "neutral", category: "Diğer", description: "İsmi sanı duyulmamış.", videoNote: "Çürük." },
  { id: 61, name: "TK Pay", status: "neutral", category: "Ulaşım", description: "THY ödeme sistemi.", videoNote: "Starbucks hesabı gibi." },
  { id: 62, name: "VakıfPays", status: "inactive", category: "Banka Destekli", description: "Cüzdan hizmetleri kapatıldı.", videoNote: "Şu an kapalı bir sistem." },
  { id: 63, name: "Vizyon Pay", status: "neutral", category: "Diğer", description: "Sitede bilgi yok.", videoNote: "Garip bir sistem." },
...
const getCompanyUrl = (companyName) => {
  const urlMap = {
    ...
    "Moneytolia": "https://www.Moneytolia.com",
